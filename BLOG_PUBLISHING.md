...
4. Click **Commit changes** to `main`. GitHub Pages will build the new article, put it at the top of [the blog](https://chhallarepiyush27.com/blog.html), and create its own shareable link. The live update may take a few minutes.
